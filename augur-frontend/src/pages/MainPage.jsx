...
function Slider({ label, value, onChange, color, accent, description }) {
  return (
    <div style={{ marginBottom: "22px" }}>
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: "8px" }}>
        ...
        <div style={{
          fontSize: "16px", fontWeight: "800", color, fontFamily: "monospace",
      ...
      <div style={{ position: "relative", height: "6px", background: "#f1f5f9", borderRadius: "3px" }}>
        <div style={{
          ...
          width: `${value}%`, background: color, borderRadius: "3px",
...
export default function MainPage({ onGenerate, scoringWeights, setScoringWeights }) {
  ...
  const set = (key, val) => setScoringWeights(prev => ({ ...prev, [key]: val }))
  const total = cashWeight + profitWeight + growthWeight
    ...
    <div style={{ minHeight: "calc(100vh - 56px)", background: "#fafafa", fontFamily: "Georgia, serif", padding: "40px" }}>
      <div style={{ maxWidth: "680px", margin: "0 auto" }}>
        ...
        <div style={{ marginBottom: "36px" }}>
          ...
          <h1 style={{ fontSize: "32px", fontWeight: "800", color: "#0f172a", letterSpacing: "-1px", margin: "0 0 10px", lineHeight: 1.1 }}>
            Make the Best Move
          </h1>
        ...
        <div style={{ background: "white", borderRadius: "12px", border: "1px solid #e2e8f0", padding: "24px 28px", marginBottom: "16px", boxShadow: "0 1px 4px rgba(0,0,0,0.04)" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "22px" }}>
            ...
            <div style={{
              ...
              border: `1px solid ${isOver ? "#fecaca" : "#bbf7d0"}`,
              fontSize: "10px", fontFamily: "monospace", fontWeight: "700",
              color: isOver ? "#ef4444" : "#16a34a",
            }}>
              {isOver ? `⚠ ${total} — reduce to balance` : `✓ TOTAL: ${total}`}
            </div>
          </div>
          ...
          <Slider
            ...
            onChange={v => set("profitWeight", v)}
          />
          <Slider
            label="Customer Growth"
            description="How many customers are being served per day by the end."
            value={growthWeight}
            color={CARD_COLORS[2]}
            accent={CARD_ACCENTS[2]}
            onChange={v => set("growthWeight", v)}
          />
        </div>
        ...
        <div style={{ background: "white", borderRadius: "12px", border: "1px solid #e2e8f0", padding: "24px 28px", marginBottom: "16px", boxShadow: "0 1px 4px rgba(0,0,0,0.04)" }}>
          ...
          <div style={{
            ...
            background: riskProfile.bg, border: `1px solid ${riskProfile.border}`,
          }}>
        ...
        <div style={{ background: "white", borderRadius: "12px", border: "1px solid #e2e8f0", padding: "20px 24px", marginBottom: "28px", boxShadow: "0 1px 4px rgba(0,0,0,0.04)" }}>
          ...
          <div style={{ fontSize: "12px", color: "#64748b", lineHeight: 1.8 }}>
            Each discovered path is normalized across all strategies, then weighted by your goals. Risk tolerance penalizes strategies where cash runway drops dangerously low. Final scores are clamped 0–100.
          </div>
        </div>
